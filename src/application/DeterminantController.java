...
public class DeterminantController implements Initializable,EventHandler<KeyEvent>{
	...
	public void initialize(URL arg0, ResourceBundle arg1) {	
		...
		SpinnerValueFactory<Integer>valueFactory=new SpinnerValueFactory.IntegerSpinnerValueFactory(1,20,initialValue);
	...
	public void result() throws IOException {
		...
		resultController.calDeterminant();
		
		Scene scene=new Scene(root);
		Stage stage=new Stage();
		stage.setScene(scene);
		stage.setTitle("Result of Matrix Determinant");
		stage.show();
